...
class AntlrPriorityQueueMLReducer : public SourceReducer {
  llvm::StringRef propertyChecker;
  llvm::raw_ostream& out;

public:
  AntlrPriorityQueueMLReducer(Listener& listener,
                       llvm::StringRef propertyChecker,
                       llvm::raw_ostream& out)
    : SourceReducer{listener},
      propertyChecker{propertyChecker},
...
class AntlrPriorityQueueMLFixpointReducer : public SourceReducer {
  llvm::StringRef propertyChecker;
  llvm::raw_ostream& out;

public:
  AntlrPriorityQueueMLFixpointReducer(Listener& listener,
                                    llvm::StringRef propertyChecker,
                                    llvm::raw_ostream& out)
    : SourceReducer{listener},
      propertyChecker{propertyChecker},
