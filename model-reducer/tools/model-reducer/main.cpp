...
cl::opt<ReducerMode> reducerMode{
  ...
  cl::values(
    ...
    clEnumValN(ReducerMode::QUEUE,    "queue",
     ...
     clEnumValN(ReducerMode::ML,    "ml",
      "priority queue grammar driven test case reduction with machine learning model suggestions for correct syntax and semantic removals"),
    ...
    clEnumValN(ReducerMode::ML_FP, "ml-fixpoint",
      "priority queue and machine learning based fixpoint reduction")
  ),
  cl::cat{reducerCategory},
...
getSourceReducer(SourceReducer::Listener& listener,
  ...
  switch (mode) {
    ...
    case ReducerMode::ML:
      return std::make_unique<AntlrPriorityQueueMLReducer>(listener, checkerPath, out);
    ...
    case ReducerMode::ML_FP:
      return std::make_unique<AntlrPriorityQueueMLFixpointReducer>(listener, checkerPath, out);
